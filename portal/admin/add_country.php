...
if($_POST['submit']) 
{
	$sqlcheck_user="select id from country where country='".$_POST['country']."'";
	$result1=mysql_query($sqlcheck_user) or die(mysql_error());
		  if(mysql_num_rows($result1) > 0)
		   {
			$url="add_country.php?mess=Country Name Already Exist";
			redirectPage($url);
			exit;
		   }	
	...
	{   
		...
		$dbcon->insert_query("country",$content);
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>	Add Country</b> 
				   </td>
			  </tr>
			</tbody>
			</table>
             ...
             <? if($_REQUEST['mess']) 
			   {
                ...
                <tr> 
                  <td width="19%" align="right" valign="top">Country Name : </td> 
                  <td width="81%" height="25" valign="top" ><input type="text" class="txtbox" value="" name="country" id="country" /></td> 
                </tr>
                <tr> 
                  <td width="19%" align="right" valign="top">Country Code : </td> 
