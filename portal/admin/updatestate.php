...
if($_POST['submit']) 
{
	if($_POST['state']) 
	{
		...
		$dbcon->update_query("state",$content,$condition);
...
$dbcon->execute_query("select * from state where id=$cit_id");
 ...
 <input type="hidden" value="<?=$cit_id?>" name="cit_id"?>
		<table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr> 
              ...
              <td width="81%" height="25" valign="top" ><input type="text" class="txtbox" value="<?=$Records['state']?>" name="state" id="state" /> </td> 
            </tr>
            <tr> 
