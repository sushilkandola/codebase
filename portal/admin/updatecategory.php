...
if($_POST['submit']) 
{
	if($_POST['cname']) 
	{
		...
		$dbcon->update_query("category",$content,$condition);
...
$dbcon->execute_query("select * from category where id=$cit_id");
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>	Update Metropolitan Area</b> 
				   </td>
			  </tr>
			</tbody>
			</table>
 ...
 <input type="hidden" value="<?=$cit_id?>" name="cit_id"?>
		<table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr> 
              ...
              <td width="81%" height="25" valign="top" ><select name="pid" class="txtbox"><?php return_category($Records['pid']);?></select></td> 
            </tr>
            <tr> 
              <td width="19%" align="right" valign="top">Category Name : </td> 
              <td width="81%" height="25" valign="top" ><input type="text" class="txtbox" value="<?=$Records['cname'];?>" name="cname" id="cname" /></td> 
            </tr>             
