	   ...
	   if($_POST['changeStatus']=='delete') 
		{
		   ...
		   $dbcon->execute_query("delete from category where id in($cit_id)");
		   //$dbcon->execute_query("delete from city where id in($cit_id)");
		   $mess="Record deleted successfully.";
		   echo "<SCRIPT language=\"JavaScript\">window.location=\"category.php?mess=".base64_encode($mess)."\";</SCRIPT>";
		}
     }
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  ?>
		...
		<div>Records Per Page:
			<select name="pagesize" id="pagesize" onchange="location.href='category.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
                   ...
                   <td class="content-box-header">
					<form name="createCity" method="post" action="add_category.php">
                    <div style="float:right">
                    <input class="button"  type="submit" name="createcity" value="Add New Category" >
					</div>
                    </form>
				   </td>
			  </tr>
    ...
    ?>
		  <tr>
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>ID</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Category</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Parent Category</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Created</b> </th>
			  ...
			  <tr>
                ...
                <td bgcolor='<?=$CL?>'><? echo $records['id'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['cname'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo return_category_name($records['pid']);?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['created'];?></td>
                <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('updatecategory.php','<?=$records['id']?>','cit_id','frm');">
