...
if($_POST['submit']) 
{
	if($_POST['city_name']) 
	{
		...
		$dbcon->update_query("city",$content,$condition);
...
<form action='#' method='post' onSubmit="return checkall(this)" name="frm"> 
 <input type="hidden" value="<?=$cit_id?>" name="cit_id"?>
		<table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr> 
              <th width="19%" align="right" valign="top">City Name : </th> 
              <td width="81%" height="25" valign="top" >
              <input type="text" class="txtbox" value="<?=$Records['city_name']?>" name="city_name" id="city_name" />
               </td> 
            </tr>
