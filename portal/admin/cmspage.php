<?
    ...
    $sql="select * from cmspage where 1 order by id desc";
	   ...
	   if($_POST['changeStatus']=='delete') 
		{
		   ...
		   $dbcon->execute_query("delete from cmspage where id in($cit_id)");
		   $mess="Record deleted successfully.";
		   echo "<SCRIPT language=\"JavaScript\">window.location=\"cmspage.php?mess=".base64_encode($mess)."\";</SCRIPT>";
		}
     }
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  ?>
		...
		<div>Records Per Page:
			<select name="pagesize" id="pagesize" onchange="location.href='cmspage.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>CMS Page</b> 
				   </td>
                   
                   <td class="content-box-header">
					<form name="createCity" method="post" action="cmspage_manage.php">
                    <div style="float:right">
                    <input class="button"  type="submit" name="createcity" value="Add New Page" >
					</div>
                    </form>
				   </td>
			  </tr>
    ...
    ?>
		  <tr>
			 <th width="2%" bgcolor="#FFFFFF">
			 	<input name="check_all" id="check_all" value="1" onclick="checkall(this.form)"  type="checkbox" disabled="disabled">
			  </th>			 
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Page Heading</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Meta Title</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Meta Keywords</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Meta Description</b> </th>
              <th align="left" width="60%" bgcolor="#FFFFFF"><b>Page Content</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Status</b> </th>
              ...
              ?>
			  <tr>
				<td align="center" bgcolor='<?=$CL?>'><input name="arr_pd_ids[]" id="arr_pd_ids[]" value="<?=$records['id']?>" type="checkbox" disabled="disabled"></td>
                <td bgcolor='<?=$CL?>'><? echo $records['heading'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['title'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['keywords'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['description'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['page_content'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['status'];?> </td>
                <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('cmspage_manage.php','<?=$records['id']?>','cit_id','frm');"> <img src="resources/images/icons/pencil.png" alt="Edit" border="0" height="16" width="16"></span> </td> 
  			</tr>
              <?
         $i++; }
              ?>
