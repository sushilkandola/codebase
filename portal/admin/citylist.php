<?
    ...
    $sql="select * from city where 1 order by city_name";
	   ...
	   if($_POST['changeStatus']=='delete') 
		{
		   ...
		   echo "<SCRIPT language=\"JavaScript\">window.location=\"citylist.php?mess=".base64_encode($mess)."\";</SCRIPT>";
		}
     }
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  ?>
		...
		<div>Records Per Page:
			<select name="pagesize" id="pagesize" onchange="location.href='citylist.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>City List</b> 
				   </td>
                   
                   <td class="content-box-header">
					<form name="createCity" method="post" action="add_city.php">
                    <div style="float:right">
                    <input class="button"  type="submit" name="createcity" value="Add New City" >
					</div>
                    </form>
				   </td>
			  </tr>
    ...
    ?>
		  <tr>
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>City</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>State</b> </th>
			  ...
			  <tr>
                ...
                <td bgcolor='<?=$CL?>'><? echo $records['city_name'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo return_state_name($records['sid']);?> </td>
                <td bgcolor='<?=$CL?>'><? echo return_country_name($records['cid']);?> </td>
				
                <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('updatecity.php','<?=$records['id']?>','cit_id','frm');">
