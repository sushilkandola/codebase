...
if($_POST['submit']) 
{
	$sqlcheck_user="select id from state where state='".$_POST['state']."'";
	$result1=mysql_query($sqlcheck_user) or die(mysql_error());
		  if(mysql_num_rows($result1) > 0)
		   {
			$url="add_state.php?mess=State Name Already Exist";
			redirectPage($url);
			exit;
		   }	
	else if($_POST['state']) 
	{   
		$content=array( "state"	=>$_POST['state'],"code"=>$_POST['code'],"cid"=>$_POST['cid']);
		$dbcon->insert_query("state",$content);
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>	Add state</b> 
				   </td>
			  </tr>
			</tbody>
			</table>
             ...
             <? if($_REQUEST['mess']) 
			   {
                  ...
                  <td width="19%" align="right" valign="top">Country : </td> 
              	  <td width="81%" height="25" valign="top" ><select name="cid" class="txtbox"><?php return_country();?></select></td> 
                </tr>
                <tr> 
                  <td width="19%" align="right" valign="top">State Name : </td> 
                  <td width="81%" height="25" valign="top" ><input type="text" class="txtbox" value="" name="state" id="state" /></td> 
                </tr>
                <tr> 
                  <td width="19%" align="right" valign="top">State Code : </td> 
                  <td width="81%" height="25" valign="top" ><input type="text" class="txtbox" value="" name="code" id="code" /></td> 
                </tr>
               
                <tr> 
              <td colspan="2" class="last" align="left" style="padding-left:210px;"> <input name="submit" type="submit" class="button" value="Submit"> 
                &nbsp;&nbsp; 
                <input name="Submit623" type="button" class="button" value="Cancel" onClick="javascript:window.location='state.php'"> 
              </td> 
            </tr> 
          </table>
				</td>
