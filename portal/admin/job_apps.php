<?php
    ...
    $sql="select * from jobs_apply where jid	='$jid' order by jid";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  ?>
		...
		<div>Records Per Page:
			<select name="pagesize" id="pagesize" onchange="location.href='job_apps.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>Job Applications for "<?=$_GET['title']?>"</b> 
				   </td>
			  </tr>
			</tbody>
			</table>
  ...
  if($countrecord>0) {
    ?>
		  <tr>
			 <th width="10%" bgcolor="#FFFFFF"><b>Sr. No. </b></th>			 
              <th align="left" width="25%" bgcolor="#FFFFFF"><b>User Name</b> </th>
              <th align="left" width="25%" bgcolor="#FFFFFF"><b>User Email</b> </th>
              <th align="left" width="25%" bgcolor="#FFFFFF"><b>Applied On</b> </th>
              </tr>
              <?
				$i=0;
