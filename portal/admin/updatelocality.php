	...
	{    
		 ...
		 else
		 {
			$content=array( "locality_name"=>$_POST['locality_name'],"city_id"=>$_POST['city_id'],"current_rate_psf"=>$_POST['current_rate_psf'],"locality_date"=>$created_date);
		        ...
		        $condition=" where locality_id =$loc_id";
				$dbcon->update_query("locality",$content,$condition);
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>	Update Locality </b> 
				   </td>
			  </tr>
			</tbody>
			</table>
<form action='#' method='post' onSubmit="return checkall(this)" name="frm" enctype="multipart/form-data"> 
		...
		<table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr> 
                  ...
                  <td width="81%" height="25" valign="top" > 
                              <input type="text" class="txtbox" value="<?=$Records['locality_name']?>" name="locality_name" id="locality_name" />
       </td> 
                </tr>
                <!--<tr> 
                   ...
                   <option value="-1">Select City</option>
                    <?php
						...
						{ $i=0;
							...
							?>
                           <option value="<?php echo $records['city_id'];?>" <?php if($records['city_id']==$Records['city_id']){ ?> selected="selected" <?php }?>><?php echo $records['city_name']; ?></option>   
                  ...
                  <td width="81%" height="25" valign="top" > 
                              <input type="text" class="txtbox" value="<?=$Records['current_rate_psf']?>" name="current_rate_psf" id="current_rate_psf" />
       </td> 
                </tr>
                  
         
               <tr> 
                  <td width="19%" align="right" style="vertical-align:middle;">Locality Info File : 
                  </td> 
                  <td width="81%" height="25" valign="top">
                   <input type="file"  value="" name="locality_info_file" class="txtbox" id="locality_info_file" />
                  ...
                  <td width="51%" height="25" valign="top" > 
                              <input type="file" value="" name="locality_map_file" id="locality_map_file" class="txtbox"/>&nbsp;
            ...
            <tr> 
              <td colspan="2" class="last" align="left" style="padding-left:210px;"> <input name="submit" type="submit" class="button" value="Update" onclick="return pubValidate();"> 
				&nbsp;&nbsp; 
                <input name="Submit623" type="button" class="button" value="Cancel" onClick="javascript:window.location='localitylist.php'"> 
 			  </td> 
            </tr> 
          </table>
				</td>
