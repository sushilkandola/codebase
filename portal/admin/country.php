<?
    ...
    $sql="select * from country where 1 order by country";
	   ...
	   if($_POST['changeStatus']=='delete') 
		{
		   ...
		   $dbcon->execute_query("delete from country where id in($cit_id)");
		   $dbcon->execute_query("delete from state where cid in($cit_id)");
		   $dbcon->execute_query("delete from city where cid in($cit_id)");
		   //$dbcon->execute_query("delete from city where id in($cit_id)");
		   $mess="Record deleted successfully.";
		   echo "<SCRIPT language=\"JavaScript\">window.location=\"country.php?mess=".base64_encode($mess)."\";</SCRIPT>";
		}
     }
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  ?>
		...
		<div>Records Per Page:
			<select name="pagesize" id="pagesize" onchange="location.href='country.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				<td class="content-box-header">
					<b style='font-size:15px;'>Country List</b> 
				   </td>
                   
                   <td class="content-box-header">
					<form name="createCity" method="post" action="add_country.php">
                    <div style="float:right">
                    <input class="button"  type="submit" name="createcity" value="Add New Country" >
					</div>
                    </form>
				   </td>
			  </tr>
    ...
    ?>
		  <tr>
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Country Name</b> </th>
              <th align="left" width="10%" bgcolor="#FFFFFF"><b>Country Code</b> </th>
			  ...
			  <tr>
                ...
                <td bgcolor='<?=$CL?>'><? echo $records['country'];?> </td>
                <td bgcolor='<?=$CL?>'><? echo $records['code'];?> </td>
				
                <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('updatecountry.php','<?=$records['id']?>','cit_id','frm');">
