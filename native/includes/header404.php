...
<meta name="reply-to" content="info@nativewebs.com" />
<meta name="allow-search" content="yes" />
<meta name="revisit-after" content="daily" />
<meta name="distribution" content="global" />
<meta name="expires" content="never" />
<meta name="language" content="english" />
<base href="http://www.nativewebs.com">
...
<script type="text/javascript" src="scripts/slidedeck.jquery.lite.js" /></script>
...
<!--Social Icons Start -->
<div>
	<div align="center" id="floatLayer" style=" background-image:url(../images/bg_fb.png); background-repeat:no-repeat;position: fixed; height: 400px; float: left; width: 76px; top: 145px;-moz-border-radius:15px;border-radius:15px; background-color:#f0f0f0; text-align:center;">
...
<div id="container"> 
  ...
  <div id="page-top">
    <div id="header-wrapper"> 
      <!-- Begin Header -->
      <div id="header">
      	<div class="fl" style="margin-top:0px;"><img src="http://hitwebcounter.com/counter/counter.php?page=4577904&style=0005&nbdigits=7&type=ip&initCount=6500" title="W Count" Alt="W Count"   border="0" ></div>
      	<div align="right" style="color:#FFF; font-size:14px; padding-top:2px;"><img src="images/phone.png" width="22" height="22"><!-- +91-8130904381--></div>
        <div style="padding-top:22px;"><a href="index.php"><img src="style/images/nativewebs.png" alt="Website Design & Development India" title="Website Design & Development" width="174" height="74" /></a></div>
        <!-- Logo --> 
        <!-- Begin Menu -->
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              <li><a href="index.php"<?php if (basename($_SERVER['SCRIPT_FILENAME'])=='') { echo 'class="selected"'; }?> title="Native Webs"><img src="style/images/home.png" width="32" height="20"></a></li>
              <li ><a href="about.php" <?php if (basename($_SERVER['SCRIPT_FILENAME'])=='about.php') { echo 'class="selected"'; }?> title="About Native Webs">About Us</a></li>
              <li><a href="career.php" <?php if (basename($_SERVER['SCRIPT_FILENAME'])=='career.php') { echo 'class="selected"'; }?> title="Careers at Native Webs">Careers</a></li>
              <li><a href="#" <?php if ((basename($_SERVER['SCRIPT_FILENAME'])=='http://blog.nativewebs.com') || (basename($_SERVER['SCRIPT_FILENAME'])=='blogInfo.php') || (basename($_SERVER['SCRIPT_FILENAME'])=='news.php') || (basename($_SERVER['SCRIPT_FILENAME'])=='newsInfo.php')) { echo 'class="selected"'; }?> title="Blogs"	>Blog</a>
                <ul>
                  <li><a href="#">Blog</a></li>
                  <li><a href="#">News</a></li>
                </ul>
              ...
              <li><a href="services.php"<?php if (basename($_SERVER['SCRIPT_FILENAME'])=='services.php') { echo 'class="selected"'; }?> title="Services">Services</a>
              	<!--<ul>
              ...
              <li><a href="contact.php" <?php if (basename($_SERVER['SCRIPT_FILENAME'])=='contact.php') { echo 'class="selected"'; }?>>Contact Us</a></li>
            </ul>
          </div>
        </div>
        <!-- End Menu --> 
